...
import logoIpsum from "../../assets/images/logoipsum-317.svg"; 
                                ...
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    <div>
                                        <Link to="/" className="d-inline-block auth-logo">
                                            <img src={logoIpsum} alt="" height="20" />
                                        </Link>
                                    </div>
                                    <p className="mt-3 fs-15 fw-medium text-white">Top grade IT Certiicates for Engieering and Software courses</p>
                                </div>
                            </Col>
                        </Row>
                                ...
                                <Card className="mt-4">
                                    ...
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Get your account now and earn a certificate</p>
                                        </div>
