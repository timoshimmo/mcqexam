          ...
          <Row>
            <Col lg={12}>
              <div className="text-center mt-sm-5 mb-4 text-white-50">
                ...
                <p className="mt-3 fs-15 fw-medium">Top grade IT Certiicates for Engieering and Software courses</p>
              </div>
            </Col>
          </Row>
              ...
              <Card className="mt-4">
                ...
                <CardBody className="p-4">
                  <div className="text-center mt-2">
                    ...
                    <p className="text-white">Reset password if you have forgotten</p>
